            ...
            <div className='shortcuts_container'>
                <div className='shortcuts'>
                    <div className='shortcut'>
                        <div className='img_container'><img src="/img/home.png" /></div>
                        <div style={{fontSize: '30px', fontWeight: 'bold'}}>학회소개</div>
                ...
                <div className='shortcuts'>
                    <div className='shortcut'>
                        <div className='img_container'><img src="/img/home.png" /></div>
                        <div style={{fontSize: '30px', fontWeight: 'bold'}}>학술행사</div>
                        <div style={{textAlign: 'center'}}>About us</div>
                    </div>
                </div>
                ...
                <div className='shortcuts'>
                    <div className='shortcut'>
                        <div className='img_container'><img src="/img/home.png" /></div>
                        <div style={{fontSize: '30px', fontWeight: 'bold'}}>회원전용</div>
                        <div style={{textAlign: 'center'}}>About us</div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="table_container">
                        <div>
                            ...
                            {users.slice(0, 6).map((value) => (
                                <div key={uniqueId} style={{display: 'flex', justifyContent: 'space-between', marginBottom: '7px'}}>
