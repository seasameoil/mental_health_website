            ...
            <div style={{display: 'flex'}}>
                ...
                <div style={{width: '100%', padding: '0 60px'}}>
                    <div style={{display: 'flex', padding: '50px 0'}}>
                        <div>
                            <div style={{display: 'flex', backgroundColor: 'white'}}>
                                <BrownBar />
                                <h3>정신건강관리사(Spiritual Health Manager)</h3>
                            </div>
                    ...
                    <div>
                        ...
                        <p>
                            1. 상기 "정신건강관리사" 자격은 국가 외의 자가 자격을 신설하여 운영하기 위해 자격기본법 규정에 따라 등록한 민간자격으로, 국가로부터 인정받은 공인자격이 아닙니다.
                            <br></br>
