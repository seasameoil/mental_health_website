            ...
            <div style={{display: 'flex'}}>
                ...
                <div style={{backgroundColor: 'pink', width: '100%', padding: '0 60px'}}>
                    <div style={{display: 'flex', padding: '50px 0', backgroundColor: 'skyblue'}}>
                        <div className='select_btn' onClick={handleClickDiv1} style={div1Style}>자격정보</div>
                        <div className='select_btn' onClick={handleClickDiv2} style={div2Style}>자격기준</div>
                    </div>
                    ...
                    {showDiv2 && 
                        <div>
                            <div style={{display: 'flex', backgroundColor: 'white'}}>
                                <BrownBar />
                                <h3>정신건강전문요원의 자격기준(제12조제1항 관련)</h3>
                            </div>
                            <p>
                                <strong>제 1 조 (목적)</strong>
                                <br></br>
