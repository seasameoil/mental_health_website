...
export default function Sub04_3_intro() {
    ...
    return(
        <div className='sub04_3_intro'>
            <SubTop />
            <div style={{display: 'flex'}}>
                <Category />
                <div style={{backgroundColor: 'pink', width: '100%', padding: '0 60px'}}>
                    <div style={{display: 'flex', padding: '50px 0', backgroundColor: 'skyblue'}}>
                        <div className='select_btn' onClick={handleClickDiv1} style={div1Style}>자격규정</div>
                        <div className='select_btn' onClick={handleClickDiv2} style={div2Style}>수련과정 시행세칙</div>
                    </div>
