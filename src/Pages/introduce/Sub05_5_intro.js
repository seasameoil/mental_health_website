...
export default function Sub05_5_intro() {
                ...
                <div style={{backgroundColor: 'pink', width: '100%', padding: '0 60px'}}>
                    <div className='top_container'>
                        <div className='top_container2'>
                            <div className='select_btn2' onClick={handle2ClickDiv1} style={div1Style2}>교수협의회</div>
                            <div className='select_btn2' onClick={handle2ClickDiv2} style={div2Style2}>정신건강임상 심리사협의회</div>
                            <div className='select_btn2' onClick={handle2ClickDiv3} style={div3Style2}>수련감독자 협의회</div>
                            <div className='select_btn2' onClick={handle2ClickDiv4} style={div4Style2}>개업전문가 협의회</div>
                        </div>
                    </div>
